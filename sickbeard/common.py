...
class Quality:
    ...
    def nameQuality(name):
        ...
        elif checkName(["720p", "web.dl|webrip|web", "264"], all) or checkName(["720p", "itunes", "h.?264"], all):
            return Quality.HDWEBDL
        elif checkName(["1080p", "web.dl|webrip|web", "264"], all) or checkName(["1080p", "itunes", "h.?264"], all):
            return Quality.FULLHDWEBDL
        elif checkName(["720p", "bluray|hddvd", "264"], all):
            return Quality.HDBLURAY
        elif checkName(["1080p", "bluray|hddvd", "264"], all):
